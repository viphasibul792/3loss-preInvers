...
const token = "8468346856:AAGawq0UoR3cFzo4xGUURfJalwAclqAZQ0U"; // এখানে আপনার নতুন টোকেন দিন
            ...
            if (lastEntry.status === "Pending") {
                ...
                if (match) {
                    ...
                    if (lastEntry.prediction === actual) {
                        ...
                        lossStreak = 0;
                        inTrendMode = false;
                        await bot.sendMessage(chatId, `🚀 RESULT: ${match.issueNumber.slice(-3)} WIN ✅✅✅✅`);
